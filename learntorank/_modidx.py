  ...
  'syms': { 'learntorank.evaluation': { 'learntorank.evaluation.EvalMetric': ( 'module_evaluation.html#evalmetric',
            ...
            'learntorank.query': { 'learntorank.query.AND': ('module_query.html#and', 'learntorank/query.py'),
                                   ...
                                   'learntorank.query.WeakAnd.get_query_properties': ( 'module_query.html#weakand.get_query_properties',
                                                                                       'learntorank/query.py'),
                                   'learntorank.query.WeakAndOld': ('module_query.html#weakandold', 'learntorank/query.py'),
                                   'learntorank.query.WeakAndOld.__init__': ( 'module_query.html#weakandold.__init__',
                                                                              'learntorank/query.py'),
                                   'learntorank.query.WeakAndOld.create_match_filter': ( 'module_query.html#weakandold.create_match_filter',
                                                                                         'learntorank/query.py'),
                                   'learntorank.query.WeakAndOld.get_query_properties': ( 'module_query.html#weakandold.get_query_properties',
                                                                                          'learntorank/query.py'),
